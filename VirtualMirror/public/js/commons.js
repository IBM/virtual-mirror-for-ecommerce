...
function renderNavBar(navbarId, exampleUri) {
  ...
  menuButtonIcon.src = '/img/menu_icon.png'
  ...
  githubLink.href = 'https://developer.ibm.com/patterns/'
  const h5 = document.createElement('h6')
  h5.innerHTML = 'Code Patterns Team'
  githubLink.appendChild(h5)
  const githubLinkIcon = document.createElement('img')
  githubLinkIcon.src = '/img/github_link_icon.png'
